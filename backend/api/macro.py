...
_HIDDEN_ALPHA_TOP = [
    {"company": "솔브레인·한솔케미칼", "tickers": ["357780", "014680"],
     "thesis": "HBM TSV 식각액 글로벌 1위, NVDA 어닝 직접 leading"},
    {"company": "SKIET", "tickers": ["361610"],
     "thesis": "분리막, IRA FEOC 중국 배제 시 ASP 프리미엄"},
    {"company": "에스티팜", "tickers": ["237690"],
     "thesis": "올리고뉴클레오타이드 글로벌 2위, GLP-1 12-18개월 알파"},
    {"company": "펩트론", "tickers": ["217340"],
     "thesis": "GLP-1 펩타이드 CDMO + 지속형 IP, LLY/NVO보다 선명한 한국 알파"},
    {"company": "에스비비테크", "tickers": ["389500"],
     "thesis": "Optimus 감속기 국산화, 휴머노이드 사이클의 진짜 알파"},
