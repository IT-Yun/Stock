...
- **에스비비테크(389500)** — 하모닉드라이브 국산화 (thematic). ⚠️ Tesla Optimus 공급사 미확인 (공식 공급: 中 Green Harmonic + Zhejiang Shuanghuan), 2025 당기순손실 -94.5억(YoY +954% 적자 확대). 검증 결과는 [[wiki/research/cross-check/robotics]] 참조 — 옵션 가치로만 평가
- **원익IPS(240810)·주성엔지(036930)** — Tier 3 장비 한국 알파

## 바이오 / 헬스
- **에스티팜(237690)** — 올리고뉴클레오타이드 글로벌 2위, GLP-1 capex 부족 시 12-18개월 알파
- **펩트론(087010)** — GLP-1 펩타이드 CDMO + 지속형 IP. ⚠️ LLY 본계약 미체결, 평가기간 24개월 연장 (2025-12). 옵션 가치는 있으나 실적 미반영 — [[wiki/research/cross-check/biotech]] 참조. 실적 기준 1순위는 알테오젠(196170, 키트루다 SC FDA+EU 승인)·에스티팜(237690, 매출 +21%)
- **알테오젠(196170)** — SC 제형 변경 IP. 2025-09 FDA + 2025-11 EU 키트루다 SC 승인 완료, 머크 로열티 본격화
- **삼성바이오로직스(207940)** — CDMO 글로벌 1위 capa. 2025년 수주 6조 돌파, 5공장 78.4만L 가동
- **클래시스(214150)·비올(335890)·제이시스메디칼(287410)** — 자체 OEM 영업이익률 40-55%, FDA 510(k) 승인이 미국 진출 trigger

## 한국 제조 / 소부장
- **더블유씨피(393890)** — 분리막. KB 11→20K (+82%), 다올 58K — base film FEOC 면제 명확화 후 SKIET 대비 새 분리막 알파 (SKIET는 1Q26 OP -701억, 컨센 Hold). [[wiki/research/cross-check/battery]]
- ~~**SKIET(361610)**~~ — FEOC base film 면제 확정으로 hidden alpha 라벨 회수. 컨센 Hold, TP 25~30K, 1Q26 영업손실 -701억
